...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/shikoku/flexsearch.min.js');loadScript('/shikoku/en.search-data.min.fddce72a4653aba3b76f36457430db2553532b83f28c393109003ca737d75f64.js',function(){input.required=false;search();});}
