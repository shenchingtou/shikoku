...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/book/flexsearch.min.js');loadScript('/book/en.search-data.min.d64fb0e9100ed1ceeed3a0c6416b2e8d985d7b1ff3f3082403b15302bcad430d.js',function(){input.required=false;search();});}
