...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/shikoku-book/flexsearch.min.js');loadScript('/shikoku-book/en.search-data.min.5fd7b786434e084143646bf6ebafccc45779354f84bfd6a8572b364cf1339d19.js',function(){input.required=false;search();});}
