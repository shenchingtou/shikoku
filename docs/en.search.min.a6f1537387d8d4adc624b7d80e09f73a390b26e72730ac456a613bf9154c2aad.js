...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/shikoku-book/flexsearch.min.js');loadScript('/shikoku-book/en.search-data.min.41bd7cc565888dbfc5b58c72477dcd781f83664de06a3505a5a1e02b0baea651.js',function(){input.required=false;search();});}
